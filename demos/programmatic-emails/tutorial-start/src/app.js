...
app.post("/send-email", async (req, res, next) => {
  try {
    ...
    const {
      ...
      htmlBody = "<strong>Hello</strong> from the programmatic emails tutorial.",
      textBody = "Hello from the programmatic emails tutorial.",
    } = body;
...
const server = app.listen(PORT, HOST, () => {
  console.log(
    `Postmark programmatic emails app listening on http://${HOST}:${PORT}`,
  );
});
