...
app.post("/send-email", async (req, res, next) => {
  try {
    ...
    const {
      ...
      htmlBody = "<strong>Hello</strong> from the send email tutorial.",
      textBody = "Hello from the send email tutorial.",
...
const server = app.listen(PORT, HOST, () => {
  console.log(
    `Postmark send email app listening on http://${HOST}:${PORT}`,
  );
});
