...
app.post("/send-email", async (req, res, next) => {
  try {
    ...
    const {
      ...
      htmlBody = "<strong>Hello</strong> from the inbound email workflow tutorial.",
      textBody = "Hello from the inbound email workflow tutorial.",
...
const server = app.listen(PORT, HOST, () => {
  console.log(
    `Postmark inbound email workflow app listening on http://${HOST}:${PORT}`,
  );
});
