...
app.post("/send-email", async (req, res, next) => {
  try {
    ...
    const {
      ...
      htmlBody = "<strong>Hello</strong> from the programmatic servers tutorial.",
      textBody = "Hello from the programmatic servers tutorial.",
    } = body;
...
const server = app.listen(PORT, HOST, () => {
  console.log(
    `Postmark programmatic servers app listening on http://${HOST}:${PORT}`,
  );
});
