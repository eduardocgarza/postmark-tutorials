...
app.post("/send-email", async (req, res, next) => {
  try {
    ...
    const {
      ...
      htmlBody = "<strong>Hello</strong> from the track opens tutorial.",
      textBody = "Hello from the track opens tutorial.",
...
const server = app.listen(PORT, HOST, () => {
  console.log(
    `Postmark track opens app listening on http://${HOST}:${PORT}`,
  );
});
