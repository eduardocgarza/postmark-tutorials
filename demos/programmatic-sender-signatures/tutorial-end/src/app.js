...
app.post("/send-email", async (req, res, next) => {
  try {
    ...
    const {
      ...
      htmlBody = "<strong>Hello</strong> from the programmatic sender signatures tutorial.",
      textBody = "Hello from the programmatic sender signatures tutorial.",
    } = body;
...
const server = app.listen(PORT, HOST, () => {
  console.log(
    `Postmark programmatic sender signatures app listening on http://${HOST}:${PORT}`,
  );
});
